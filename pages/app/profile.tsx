...
// `;
    ...
    if (loading) {
        return <h2><a href="pages/app/profile#loading" aria-hidden="true" className="aal_anchor" id="loading">
        ...
        return (
            ...
            <div className="flex min-h-screen flex-col items-center justify-center py-2">
                <Head>
                    ...
                    <link rel="icon" href="/home/lightin/Towphase/towphase-front/public/favicon.ico"/>
                </Head>
